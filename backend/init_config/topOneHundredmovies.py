...
def insert_movie(movie):
    # Inserire i dettagli del film
    cur.execute("""
        INSERT INTO movies (rank, title, description, image, big_image, thumbnail, rating, imdbid, year, imdb_link)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
        RETURNING id
    """, (movie['rank'], movie['title'], movie['description'], movie['image'], movie['big_image'], movie['thumbnail'], movie['rating'], movie['imdbid'], movie['year'], movie['imdb_link']))
    ...
    for genre in movie['genre']:
        ...
        # Associare il film con il genere
